...
~~動作確認中~~<br>
前バージョンを利用している方はテーブルを更新したため修正をお願いします。
<a href="https://github.com/takashi-koshiba/anime-web/blob/main/exec/program/db1.sql">テーブル</a> <br>
...
~~※必要なテーブルは動作確認ができ次第、pushします。~~　<br>

動画のフレームのみの判定のためあまり映像に動きがない番組では誤検知がありますが。使用は可能です。
